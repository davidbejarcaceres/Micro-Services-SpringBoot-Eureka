...
class BufferImpl extends _BufferImplBase {
	...
	public boolean get(org.omg.CORBA.StringHolder elemento) {
		...
		if (elementos >= minElementosGet) {
			...
			elemento.value = "Solo introducir o leer, no hay suficientes elementos";
			return false;
		}
	}
	...
	public boolean read(org.omg.CORBA.StringHolder elemento) {
		if (elementos != 0) {
			...
			return true;
                        ...
                        elemento.value = "No hay suficientes elementos";
			return false;
	}
		...
		if (elementos != 0) {
			...
			if(elementos==1){
				...
				return true;
                    ...
                    total_elemento.value = "No hay suficientes elementos";
                    return false;
	}
