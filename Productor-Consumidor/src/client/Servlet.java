...
public class Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<input name=\"date\" size=\"20\" placeholder=\"dd/mm/aaaa\">");
		out.println("<br><br>");
		out.println("<font face=\"Arial,Helvetica\"><font size=\"-1\">Descripción Corta:</font></font>");
		out.println("<p>");
		out.println("<textarea name=\"short_description\" rows=\"3\" cols=\"40\" placeholder=\"Ingrese descripcion corta...\"></textarea>");
		out.println("</p>");
                out.println("<font face=\"Arial,Helvetica\"><font size=\"-1\">Descripción Completa:</font></font>");
		out.println("<p>");
		out.println("<textarea name=\"long_description\" rows=\"10\" cols=\"40\" placeholder=\"Ingrese descripcion completa...\"></textarea>");
		out.println("</p>");
		...
		if (request.getParameter("action").compareTo("Enviar") == 0)
			if (request.getParameter("date").compareTo("") == 0) {
			...
			} else if (request.getParameter("short_description").compareTo("") == 0) {
				out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"red\"><font size=\"-1\">[ERROR]: El contenido del mensaje no puede estar vacío.</font></font></font></center>");
					...
					ArrayList<String> news = new ArrayList<String>(); // lista de news
					ArrayList<String> elementos = new ArrayList<String>(); // lista de elementos
					news.add(request.getParameter("date")); //para obtener valor del email
					elementos.add(request.getParameter("short_description")); //para obtener valor del dato
                                        elementos.add(request.getParameter("long_description")); //para obtener valor del dato
					empaquetador = new CoderXML(nombre_archivo);
					//crear archivo XML (empaquetar)
					if(empaquetador.empaquetar(news, elementos)){
			...
			if(bufferImpl.get(elem)){
				...
				if(empaquetador.empaquetar(elem.value)){
					...
					if(nuevo.first()){
						for (Mensaje mensaje : nuevo.second()) {
							...
							out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"red\"><font size=\"-1\">Fecha: "+mensaje.getDate()+"</font></font></font></center>");
							out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"red\"><font size=\"-1\">Descripcion corta: "+mensaje.getShort_description()+"</font></font></font></center>");
                                                        out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"red\"><font size=\"-1\">Cescripcion larga: "+mensaje.getLong_description()+"</font></font></font></center>");
						}
					}else{
				...
				out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"red\"><font size=\"-1\">[ERROR]: No recibido ["+elem.value+"].</font></font></font></center>");
			}
					...
					if(empaquetador.empaquetar(elem.value)){
						...
						if(nuevo.first()){
							for (Mensaje mensaje : nuevo.second()) {
								...
								out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Fecha: "+mensaje.getDate()+"</font></font></font></center>");
								out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Elemento: "+mensaje.getShort_description()+"</font></font></font></center>");
                                                                out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Elemento: "+mensaje.getLong_description()+"</font></font></font></center>");
							}
						}else{
							out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"red\"><font size=\"-1\">[ERROR]: El mensaje no se ha desempaquetado correctamente.</font></font></font></center>");
						}
					...
					if(empaquetador.empaquetarTodos(elem.value)){
						...
						if(nuevo.first()){
							...
							for (Mensaje mensaje : nuevo.second()) {
								out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Mensaje recibido:</font></font></font></center>");
								out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Fecha: "+mensaje.getDate()+"</font></font></font></center>");
								out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Corta: "+mensaje.getShort_description()+"</font></font></font></center>");
                                                                out.println("<br><center><font face=\"Arial,Helvetica\"><font color=\"blue\"><font size=\"-1\">Larga: "+mensaje.getLong_description()+"</font></font></font></center>");
							}
						}else{
